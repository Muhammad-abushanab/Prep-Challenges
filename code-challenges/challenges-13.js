...
const objectCounter = (obj) => {
    ...
    return obj.reduce((accumulator) => accumulator + 1, 0);
}
// -------------------------------------------------------------------------------------------------------
...
const stringReverse = (str) => {
    // write your code here
    return str.split(" ").reduce((accumulator, word) => word + " " + accumulator, "").trim();
}
// -------------------------------------------------------------------------------------------------------
...
const statistics = (obj) => {
    // write your code here
    return obj.reduce((accumulator, voter) => {
        const name = voter.votes_To;
