...
function gradesAvg(arr) {
    ...
    return arr.map(function (student) {
        let sum = 0;
        student.gradsList.forEach(grade => sum += grade);
...
function studentsResult(arr) {
    // write your code here
    let studentsWithAvg = gradesAvg(arr);
    return studentsWithAvg.map(function (student) {
        student.avg < 50 ? student.result = "Failed" : student.result = "Passed";
        return student;
    })
}
// -------------------------------------------------------------------------------------------------------
